...
from app.api import health, health_literacy, mobile_users, self_reports, sentiment_pulse
...
def create_app() -> FastAPI:
    ...
    app.include_router(sentiment_pulse.router, prefix=settings.api_prefix)
    return app
